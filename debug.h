...
#else
    #define DEBUG_Initialize()	//UART2Init()
#endif
...
#else
    // #define DEBUG_PutChar(a)	UART2PutChar(a)
    #define DEBUG_PutChar(a)	putch(a)
#endif
...
void DEBUG_PutString(char* data);
    ...
    #define DEBUG_PutString(a)	putstr(a)
#endif

/**************************************************************************
    Function:
        void DEBUG_PutDec(UINT8 data);   S.Suwa
**************************************************************************/

void DEBUG_PutDec(UINT8 data);

#if !defined(DEBUG_MODE)
    #define DEBUG_PutDec(a)
#else
    // #define DEBUG_PutDec(a)	UART2PutDec(a)
    #define DEBUG_PutDec(a)	putdec(a)
#endif
...
#else
    // #define DEBUG_PutHexUINT8(a)	UART2PutHex(a)
    #define DEBUG_PutHexUINT8(a)	puthex(a)
#endif
...
#else
    // #define DEBUG_PutHexUINT16(a)	UART2PutHexWord(a)
    #define DEBUG_PutHexUINT16(a)	puthex(a)
#endif
...
#else
    // #define DEBUG_PutHexUINT32(a)	UART2PutHexDWord(a)
    #define DEBUG_PutHexUINT32(a)	puthex(a)
#endif



#endif // __DEBUG_H S.Suwa
