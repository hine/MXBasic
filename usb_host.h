...
#define USBHostGetCurrentConfigurationDescriptor( deviceAddress) ( pCurrentConfigurationDescriptor[deviceAddress] )
...
#define USBHostGetDeviceDescriptor( deviceAddress )     ( pDeviceDescriptor[deviceAddress] )
